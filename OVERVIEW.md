...
시장 조사 → 상품 기획 → 카피 작성 → 상세페이지 → 광고 → CRM 설계 → 강의안 → 운영.
...
초기에 에이전트가 커버하지 않던 항목들이 아래로 보완됐습니다.

**webinar-script 에이전트**

- 라이브 세일즈 현장 운영 전략 및 세일즈 파트 진행 방식
- 웨비나 이탈 방지 — 콘텐츠 내부 구성 전략 (이탈방지 전략 섹션)
- 강의안 작성 방식을 고객사에게 요청하는 방법 (슬라이드 핸드오프 가이드)

→ agents/webinar-script/AGENT.md
